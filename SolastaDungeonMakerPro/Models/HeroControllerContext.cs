...
namespace SolastaDungeonMakerPro.Models
{
    ...
    {
        internal static int[] CharacterPlayersChoices = new int[Settings.MAX_PARTY_SIZE + 1];

        private static GameLocationCharacter ActiveContender = null;
        ...
        internal static List<string> GetPlayersList()
        {
            ...
            {
                for (var i = 0; i < playerSlotsList.Count; i++)
                {
