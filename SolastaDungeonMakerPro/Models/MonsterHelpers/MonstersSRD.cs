...
namespace SolastaDungeonMakerPro.Models.MonsterHelpers
{
    static class MonstersSRD
	{
		...
		public static List<Models.MonsterContext.CustomMonster> Definitions = new List<Models.MonsterContext.CustomMonster>()
		{
			...
			{
				MonsterName = "Balor",
				BaseTemplateName = DatabaseHelper.MonsterDefinitions.MinotaurElite,
			 ...
			 new Models.MonsterContext.CustomMonster()
			 {
				...
				SpriteReference=DatabaseHelper.MonsterDefinitions.Ghost_Emtan.GuiPresentation.SpriteReference,
		   ...
		   new Models.MonsterContext.CustomMonster()
		   {
			...
			new Models.MonsterContext.CustomMonster()
			{
			 ...
			 new Models.MonsterContext.CustomMonster()
			 {
					...
					MonsterName = "Vampire",
					BaseTemplateName = DatabaseHelper.MonsterDefinitions.Brood_of_blood,
					MonsterShaderReference = DatabaseHelper.MonsterDefinitions.SRD_Thug,
				...
				LegendaryActionOptions=new List<LegendaryActionDescription> ()
				{
					...
					MonstersAttributes.VampirelegendaryActionDescription_4
				},
