...
namespace SolastaDungeonMakerPro.Models.MonsterHelpers
{
    ...
    {
        static public SpellListDefinition Archmage_spelllist = ScriptableObject.CreateInstance<SpellListDefinition>();
        static public FeatureDefinitionCastSpell CastSpell_ArchMage = ScriptableObject.CreateInstance<FeatureDefinitionCastSpell>();
        static public SpellListDefinition GuardianNaga_spelllist = ScriptableObject.CreateInstance<SpellListDefinition>();
        static public FeatureDefinitionCastSpell CastSpell_GuardianNaga = ScriptableObject.CreateInstance<FeatureDefinitionCastSpell>();
        static public SpellListDefinition Lich_spelllist = ScriptableObject.CreateInstance<SpellListDefinition>();
        static public FeatureDefinitionCastSpell CastSpell_Lich = ScriptableObject.CreateInstance<FeatureDefinitionCastSpell>();

        static public FeatureDefinitionDamageAffinity FireTitan_Retaliate_DamageAffinity = ScriptableObject.CreateInstance<FeatureDefinitionDamageAffinity>();
        static public FeatureDefinitionDamageAffinity Balor_Retaliate_DamageAffinity = ScriptableObject.CreateInstance<FeatureDefinitionDamageAffinity>();
        static public FeatureDefinitionMagicAffinity AirTitan_SleetStorm_Immunity = ScriptableObject.CreateInstance<FeatureDefinitionMagicAffinity>();

        static public TA.AI.DecisionPackageDefinition AncientDragon_CombatDecisions = ScriptableObject.CreateInstance<TA.AI.DecisionPackageDefinition>();
        static public TA.AI.DecisionPackageDefinition PitFiend_CombatDecisions = ScriptableObject.CreateInstance<TA.AI.DecisionPackageDefinition>();
        static public TA.AI.DecisionPackageDefinition Balor_CombatDecisions = ScriptableObject.CreateInstance<TA.AI.DecisionPackageDefinition>();
        static public TA.AI.DecisionPackageDefinition Nalfeshnee_CombatDecisions = ScriptableObject.CreateInstance<TA.AI.DecisionPackageDefinition>();
        static public TA.AI.DecisionPackageDefinition Solar_CombatDecisions = ScriptableObject.CreateInstance<TA.AI.DecisionPackageDefinition>();
        static public TA.AI.DecisionPackageDefinition HighLevelCaster_CombatDecisions = ScriptableObject.CreateInstance<TA.AI.DecisionPackageDefinition>();
        static public TA.AI.DecisionPackageDefinition Naga_CombatDecisions = ScriptableObject.CreateInstance<TA.AI.DecisionPackageDefinition>();
        static public TA.AI.DecisionPackageDefinition Vampire_CombatDecisions = ScriptableObject.CreateInstance<TA.AI.DecisionPackageDefinition>();
        static public TA.AI.DecisionPackageDefinition Titan_CombatDecisions = ScriptableObject.CreateInstance<TA.AI.DecisionPackageDefinition>();

        static public TA.AI.DecisionDefinition AtWillAOE_Magic_Decision = ScriptableObject.CreateInstance<TA.AI.DecisionDefinition>();
        static public TA.AI.DecisionDefinition AtWillSelfBuff_Magic_Decision = ScriptableObject.CreateInstance<TA.AI.DecisionDefinition>();
        static public TA.AI.DecisionDefinition LimitedPerDayTargetDebuff_Magic_Decision = ScriptableObject.CreateInstance<TA.AI.DecisionDefinition>();
        static public TA.AI.DecisionDefinition LimitedPerDayAOE_Magic_Decision = ScriptableObject.CreateInstance<TA.AI.DecisionDefinition>();
        static public TA.AI.DecisionDefinition SummonCreature_Magic_Decision = ScriptableObject.CreateInstance<TA.AI.DecisionDefinition>();
        static public TA.AI.DecisionDefinition CastMagic_Stoneskin_Decision = ScriptableObject.CreateInstance<TA.AI.DecisionDefinition>();

        static public Dictionary<string, string> Dictionaryof_Dragon_DamageAffinity = new Dictionary<string, string>();


        static public List<String> ListofDamageTypes_Dragon = new List<string> { "DamageAcid", "DamagePoison", "DamageFire", "DamageCold", "DamageLightning" };
        static public List<String> ListofDamageTypes_Physical = new List<string> { "DamageSlashing", "DamageBludgeoning", "DamagePiercing" };
        static public List<String> ListofDamageTypes_Other = new List<string> { "DamageThunder", "DamagePsychic", "DamageForce", "DamageNecrotic", "DamageRadiant" };
...

        {
            ...
            */
            ...
            LichSpell_Cantrips.Spells = new List<SpellDefinition>();
           ...
           // LichSpell_Cantrips.Spells.Add(DatabaseHelper.SpellDefinitions.ChillTouch);
            ...
            LichSpell_level_1.Spells = new List<SpellDefinition>();
            LichSpell_level_1.Level = 1;
            ...
            LichSpell_level_2.Spells = new List<SpellDefinition>();
            LichSpell_level_2.Level = 2;
            ...
            LichSpell_level_3.Spells = new List<SpellDefinition>();
            LichSpell_level_3.Level = 3;
            ...
            LichSpell_level_4.Spells = new List<SpellDefinition>();
            LichSpell_level_4.Level = 4;
            ...
            LichSpell_level_5.Spells = new List<SpellDefinition>();
            LichSpell_level_5.Level = 5;
            ...
            LichSpell_level_6.Spells = new List<SpellDefinition>();
            LichSpell_level_6.Level = 6;
            ...
            LichSpell_level_7.Spells = new List<SpellDefinition>();
            LichSpell_level_7.Level = 7;
            ...
            LichSpell_level_8.Spells = new List<SpellDefinition>();
            LichSpell_level_8.Level = 8;
            ...
            LichSpell_level_9.Spells = new List<SpellDefinition>();
            LichSpell_level_9.Level = 9;
...

        {
            ...
            */
            ...
            ArchmageSpell_Cantrips.Spells = new List<SpellDefinition>();
            ...
            ArchmageSpell_level_1.Spells = new List<SpellDefinition>();
            ArchmageSpell_level_1.Level = 1; 
            ...
            ArchmageSpell_level_2.Spells = new List<SpellDefinition>();
            ArchmageSpell_level_2.Level = 2;
            ...
            ArchmageSpell_level_3.Spells = new List<SpellDefinition>();
            ArchmageSpell_level_3.Level = 3;
            ...
            ArchmageSpell_level_4.Spells = new List<SpellDefinition>();
            ArchmageSpell_level_4.Level = 4;
            ...
            ArchmageSpell_level_5.Spells = new List<SpellDefinition>();
            ArchmageSpell_level_5.Level = 5;
            ...
            ArchmageSpell_level_6.Spells = new List<SpellDefinition>();
            ArchmageSpell_level_6.Level = 6; 
            ...
            ArchmageSpell_level_7.Spells = new List<SpellDefinition>();
            ArchmageSpell_level_7.Level = 7;
            ...
            ArchmageSpell_level_8.Spells = new List<SpellDefinition>();
            ArchmageSpell_level_8.Level = 8;
            ...
            ArchmageSpell_level_9.Spells = new List<SpellDefinition>();
            ArchmageSpell_level_9.Level = 9;
...

        {
            ...
            GuardianNagaSpell_Cantrips.Spells = new List<SpellDefinition>();
            ...
            GuardianNagaSpell_level_1.Spells = new List<SpellDefinition>();
            GuardianNagaSpell_level_1.Level = 1;
            ...
            GuardianNagaSpell_level_2.Spells = new List<SpellDefinition>();
            GuardianNagaSpell_level_2.Level = 2;
            ...
            GuardianNagaSpell_level_3.Spells = new List<SpellDefinition>();
            GuardianNagaSpell_level_3.Level = 3;
            ...
            GuardianNagaSpell_level_4.Spells = new List<SpellDefinition>();
            GuardianNagaSpell_level_4.Level = 4;
            ...
            GuardianNagaSpell_level_5.Spells = new List<SpellDefinition>();
            GuardianNagaSpell_level_5.Level = 5;
            ...
            GuardianNagaSpell_level_6.Spells = new List<SpellDefinition>();
            GuardianNagaSpell_level_6.Level = 6;
        ...
        {
            var unit = CopyAndCreateNewBlueprint<FeatureDefinitionCastSpell>.CreateCopy(name,
                                                                                        guid,
                                                                                        title,
                                                                                        description,
                                                                                        baseCaster
        ...
        {
            var unit = CopyAndCreateNewBlueprint<FeatureDefinitionDamageAffinity>.CreateCopy(name,
                                                                                            guid,
                                                                                            title,
                                                                                            description,
                                                                                            baseDamageAffinity
        ...
        {
            var unit = CopyAndCreateNewBlueprint<TA.AI.DecisionPackageDefinition>.CreateCopy(name,
                                                                                            guid,
                                                                                            title,
                                                                                            description,
        ...
        {
            var unit = CopyAndCreateNewBlueprint<TA.AI.DecisionDefinition>.CreateCopy(name,
                                                                             guid,
                                                                             title,
                                                                             description,
        ...
        {
            var unit = CopyAndCreateNewBlueprint<MonsterPresentationDefinition>.CreateCopy(name,
                                                                             guid,
                                                                             title,
                                                                             description,
        ...
        {
            var unit = CopyAndCreateNewBlueprint<FeatureDefinitionMagicAffinity>.CreateCopy(name,
                                                                             guid,
                                                                             title,
                                                                             description,
                                                                             baseMagicAffinity
        ...
        {
            var unit = CopyAndCreateNewBlueprint<SpellListDefinition>.CreateCopy(name,
                                                                             guid,
                                                                             title,
                                                                             description,
                                                                             baseSpellList
