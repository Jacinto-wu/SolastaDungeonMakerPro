...
namespace SolastaDungeonMakerPro.Models.MonsterHelpers
{
    ...
    {
        static public SpellDefinition DominateMonster_Spell = ScriptableObject.CreateInstance< SpellDefinition>();
        static public SpellDefinition PowerWordKill_Spell = ScriptableObject.CreateInstance<SpellDefinition>();
        static public SpellDefinition PowerWordStun_Spell = ScriptableObject.CreateInstance<SpellDefinition>();
        static public SpellDefinition FingerOfDeath_Spell = ScriptableObject.CreateInstance<SpellDefinition>();
        static public SpellDefinition ReverseGravity_Spell = ScriptableObject.CreateInstance<SpellDefinition>();
        static public SpellDefinition TimeStop_Spell = ScriptableObject.CreateInstance<SpellDefinition>();
       ...
       public static void BuildNewFingerOfDeath_Spell()
        ...
        {
            var unit = CopyAndCreateNewBlueprint<SpellDefinition>.CreateCopy(name,
                                                                             guid,
                                                                             title,
                                                                             description,
                                                                             baseSpell
