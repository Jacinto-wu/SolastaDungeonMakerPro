    ...
    static class MonstersHomebrew
    {
        ...
        public static List<Models.MonsterContext.CustomMonster> Definitions = new List<Models.MonsterContext.CustomMonster>()
        {
            ...
            new Models.MonsterContext.CustomMonster()
            {
                ...
                CR = 20,
                LegendaryCreature = true,
                BaseTemplateName = DatabaseHelper.MonsterDefinitions.Earth_Elemental,
        ...
        public static void EnableInDungeonMaker()
        {
            ...
            {
                MonsterBuilder NewMonster = new MonsterBuilder(
                ...
                if (Definitions[i].MonsterName == "Construct Titan")
                {
                    ...
                    MonsterAttackIteration AttackIteration_2 = new MonsterAttackIteration();
                    AttackIteration_2.SetField("monsterAttackDefinition", DatabaseHelper.MonsterAttackDefinitions.Attack_Goblin_PebbleThrow);// CreateAndAddNewMonsterAttacks.ConstructTitan_ForceCannon_Attack);
                    AttackIteration_2.SetField("number", 1);
                    ...
                    legendaryActionDescription.SetCost(1);
                    legendaryActionDescription.SetSubaction(LegendaryActionDescription.SubactionType.Power);
                    legendaryActionDescription.SetFeatureDefinitionPower(NewMonsterPowers.IncreasedGravityZone_Power);
                    legendaryActionDescription.SetDecisionPackage(DatabaseHelper.DecisionPackageDefinitions.LegendaryDragonWingAttack);

                    NewMonster.AddLegendaryActionOptions(new List<LegendaryActionDescription> { legendaryActionDescription });
                    ...
                    // waiting until iron golem construct visual model is added to game.
                ...
                NewMonster.SetCustomShaderReference(Definitions[i].MonsterShaderReference);
